...
Checksum: The total number of rows in the updated dataset (`r rows_total_new`) is equal to the number of fully populated rows (`r rows_complete_new`) in the updated dataset.
...
```{r plot_steps_per_day_new, echo=TRUE}
# Determine the steps per day.
